...
export default function SignUp(){
	...
	<div className="bg-white flex shadow px-8 py-8 rounded-[20px] flex-col justify-center flex-wrap mx-auto max-w-md items-center gap-2 ">
		...
		<form className="flex flex-col justify-center items-start w-full mt-5 gap-2">
			...
			<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" placeholder="john1"></input>
			<p className=" text-black text-lg">First Name</p>
			<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" placeholder="John"></input>
			<p className=" text-black text-lg">Last Name</p>
			<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" placeholder="Doe"></input>
			<p className=" text-black text-lg">Email</p>
			<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" placeholder="JohnDoe@gmail.com"></input>
			<p className=" text-black text-lg">Password</p>
			<div className="w-full relative flex jusitfy-center items-center">
				{show?<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" type="text" placeholder="1234"></input>:
				<input className=" focus:border-black focus:outline-none border-solid border-2 rounded-md w-full h-9 px-2" type="password" placeholder="1234"></input>}
		...
		<button type="submit" className=" bg-gray-800 px-2 py-2 w-full rounded-lg text-white text-lg mt-2">Sign Up</button>
